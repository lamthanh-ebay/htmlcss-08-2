...
function load(selector, path) {
    ...
    fetch(path)
        ...
        */
/************************************* Tính từ phần tạo Dropdown Menu *************************************/
 ...
 * 3. Thêm translate: -50%; vào ::before chứa ảnh arrow nhé.
 * Lúc đó arrow sẽ nằm chính giữa li (item).
 */
...
function handleActiveMenu() {
    ...
    const activeClass = "navbar-dropdown-menu__item--active";
...
window.addEventListener("template-loaded", () => {
    ...
    links.forEach((link) => {
        link.onclick = () => {
            ...
            item.classList.toggle("navbar-menu__item--active");
        };
    });
});
 ...
 *
 * Cách dùng:
 * 1 - <button class="js-toggle" toggle-target="#box">Click</button>
 * 2 - <div id="box">Content show/hide</div>
 */
...
function initJsToggle() {
    $$(".js-toggle").forEach((button) => {
        ...
        button.onclick = (e) => {
            e.preventDefault();
            // Thêm e và 1 dòng code ở trên để loại bỏ hành động mặc định.
            // Xem thêm Video => Làm form filter sản phẩm #5 - Project 8
